        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertificateImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorCertificates_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorSpecialties_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentSpecialties", x => new { x.AppointmentId, x.SpecialtyId });
                    table.ForeignKey(
                        name: "FK_AppointmentSpecialties_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentSpecialties_Specialties_SpecialtyId",
                        column: x => x.SpecialtyId,
                        principalTable: "Specialties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Çift Terapisi" },
                    { 7, "Yeme Bozuklukları" },
                    { 8, "Bağımlılık Tedavisi" },
                    { 9, "Kişilik Bozuklukları" },
                    { 10, "Yaşlı Psikolojisi" },
                    { 11, "Ergen Psikolojisi" },
                    { 12, "Kariyer Danışmanlığı" },
                    { 13, "Stres Yönetimi" },
                    { 14, "Öfke Yönetimi" },
                    { 15, "Sosyal Fobi" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSpecialties_SpecialtyId",
                table: "AppointmentSpecialties",
                column: "SpecialtyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ExperienceStartDate",
                table: "AspNetUsers",
                column: "ExperienceStartDate");
